...
namespace Drupal\jwt_firebase_auth_consumer\Plugin\rest\resource;
 ...
 *
 * @RestResource(
 *   id = "create_firebase_drupal_user",
 *   label = @Translation("Create corresponding drupal user for a firebase user."),
 *   uri_paths = {
 *     "canonical" = "rest/api/v1/create-firebase-drupal-user",
 *     "create" = "rest/api/v1/create-firebase-drupal-user",
 *   }
 * )
 */
class CreateFirebaseDrupalUser extends ResourceBase {
  ...
  /**
   * Responds to firebase drupal user registration POST request.
   *
